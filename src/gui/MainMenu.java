...
public class MainMenu extends JPanel {
	...
	public void createAndShowGUI() throws IOException {
		...
		Image image = ImageIO.read(this.getClass().getResource("/logores.jpg"));
		Image imageScaled = image.getScaledInstance(350, 300, Image.SCALE_SMOOTH);
		ImageIcon imageIcon = new ImageIcon(imageScaled);
		picLabel = new JLabel(imageIcon);
		Box right = Box.createVerticalBox();
		panel_1 = new Panel();
		title = new JLabel("Spiderman Online Food Services");
	...
	public static void main(String args[]) throws IOException {
		...
		frame = new JFrame();
		frame.setTitle("Spiderman Online Food Services");
